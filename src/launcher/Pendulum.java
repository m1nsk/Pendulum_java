...
public class Pendulum {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, I2CFactory.UnsupportedBusNumberException {
        ...
        classLoader = device.getClass().getClassLoader();
        ...
        PendulumStateMachine stateMachine = new PendulumStateMachineImpl(Collections.emptyList(), imgStorage, sizeX, params.getPolarYSize());
